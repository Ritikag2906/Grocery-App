                ...
                return GestureDetector(
                  ...
                  onTap: _selectedList.isNotEmpty
                      ? () {
                          ...
                          setState(() {
                            _selectedList.contains(i)
                                ? _selectedList.remove(i)
                                : _selectedList.add(i);
                          });
                        }
                      : () {
                          ...
                          showCupertinoDialog(
                              ...
                              builder: (context) => Theme(
                                    ...
                                    child: CupertinoAlertDialog(
                                        title: Text(
                                            groceryList[i].name.toString()),
                                        content: CustomDialogueBox(
                                          image:
                                              groceryList[i].image.toString(),
                                          price:
                                              groceryList[i].price.toString(),
                                          quantity: groceryList[i]
                                              .quantity
                                              .toString(),
                                        )),
                                  ));
                      ...
                      if (_selectedList.isNotEmpty)
                        Positioned(
                          ...
                          child: Icon(Icons.check_circle,
                              color: _selectedList.contains(i)
